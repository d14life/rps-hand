import {drawFace,drawShoulders,encodeAux,decodeAux} from './face-overlay.mjs?v=19.7';
import {startTracking,defaults} from './tracking-session.mjs?v=19.7';
...
export function receivePhone(onResult,onStatus,onEnd,onAux=()=>{},getOptions=()=>defaults,onStats=()=>{}){
 ...
 const url=new URL('camera.html',import.meta.url);url.searchParams.set('pair',id);url.searchParams.set('v','19.7');
