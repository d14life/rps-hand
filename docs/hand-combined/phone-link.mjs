import {drawFace,encodeAux,decodeAux} from './face-overlay.mjs?v=19';
import {startTracking,defaults} from './tracking-session.mjs?v=19';
...
export function receivePhone(onResult,onStatus,onEnd,onAux=()=>{},getOptions=()=>defaults,onStats=()=>{}){
 ...
 const url=new URL('camera.html',import.meta.url);url.searchParams.set('pair',id);url.searchParams.set('v','19');
