...
let paths=0;drawFace({beginPath(){paths++;},moveTo(){},lineTo(){},stroke(){}},result.face.points,480,640);assert.equal(paths,5);assert.ok(faceIds.length<50);console.log('PASS sparse face transport, outline and schematic nose/mouth without dots');
