import {calibratedReference} from './reference-scale.mjs?v=vda2';
import {fitNeckSweep} from './neck-sweep.mjs?v=vda2';
import {OneHandSweep} from './one-hand-sweep.mjs?v=vda2';
...
export function installExperiment({container,getHead,getFocal=()=>1,onReference=()=>{},onBegin=()=>{},getNeckReference=()=>null}){
 ...
 panel.innerHTML=`<h2>Front-to-neck sweep · Video Depth 2</h2>
