import {fitNeckSweep} from './neck-sweep.mjs?v=vda1-final';
import {OneHandSweep} from './one-hand-sweep.mjs?v=vda1-final';
...
export function installExperiment({container,getHead,getFocal=()=>1,onReference=()=>{},onBegin=()=>{},getNeckReference=()=>null}){
 ...
 panel.innerHTML=`<h2>Front-to-neck sweep · Video Depth 1</h2>
