import {palmObservation} from './palm-sweep-depth.mjs?v=vda2';
import {imagePalmSize} from './size-wall-depth.mjs';
import {solveTouchDepth} from './hand-pair-depth.mjs?v=vda2';
import {sweepEndpoints} from './one-hand-sweep.mjs?v=vda2';
