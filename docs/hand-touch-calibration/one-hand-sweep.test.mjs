...
for(let now=5000;now<13000;now+=100){const r=sweep.update(now,[hand(now)],{points:[]});assert.match(r.message,/upward and back to the top of your head/);}
...
assert.match(sweep.update(13000,[],null).message,/start 0\/3, top of head 0\/3/,'failed capture reports endpoint counts');
