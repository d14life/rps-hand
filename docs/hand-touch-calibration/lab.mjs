import {fitVideoCalibration,videoDepth} from './video-calibration.mjs?v=touch2.4.4';
let recordedFit=null;
import {installVideoReplay} from './video-replay.mjs?v=touch2.4.4';
let videoReplay=null;
import {OuterCollision} from './outer-collision.mjs?v=touch2.4.4';
import {HandContactAssist} from './hand-contact-assist.mjs?v=touch2.4.4';
import {installExperiment} from './experiment.mjs?v=touch2.4.4';
...
import {installCombinedUI} from './combined-ui.mjs?v=touch2.4.4';
import {CombinedHead} from './head-model.mjs?v=touch2.4.4';
import {directDriver} from './direct.mjs?v=touch2.4.4';
import {reduceFalseDepthBends} from './depth-lines.mjs?v=touch2.4.4';
...
function rawSizePoints(world,lm){
 ...
 const baseDepth=sizeDepth(size,{size:modelPalmSpan*focal,depth:1},depthStates[side]?.depth||.5),depth=videoReplay?.active?videoDepth(recordedFit,side,size,baseDepth):(depthExperiment?.depth(side,lm,world,baseDepth,captureAspect)??baseDepth);depthStates[side]={depth};
