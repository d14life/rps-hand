import {fitVideoCalibration,videoDepth} from './video-calibration.mjs?v=touch2.4.3';
let recordedFit=null;
import {installVideoReplay} from './video-replay.mjs?v=touch2.4.3';
let videoReplay=null;
import {OuterCollision} from './outer-collision.mjs?v=touch2.4.3';
import {HandContactAssist} from './hand-contact-assist.mjs?v=touch2.4.3';
import {installExperiment} from './experiment.mjs?v=touch2.4.3';
...
import {installCombinedUI} from './combined-ui.mjs?v=touch2.4.3';
import {CombinedHead} from './head-model.mjs?v=touch2.4.3';
import {directDriver} from './direct.mjs?v=touch2.4.3';
import {reduceFalseDepthBends} from './depth-lines.mjs?v=touch2.4.3';
...
const contactPanel=document.createElement('section');contactPanel.style.display='block';contactPanel.innerHTML='<h2>Optional contact</h2><p>Off by default for camera input. Recorded movement enables index contact matching and head/neck collision protection after its calibration pass. Enable contact matching to close touching finger lines; enable outer collisions to protect the two hands. Hand/head collisions are separate and off by default so moving the head does not push your hands. Finger joints within one hand use bending limits, not self-collision.</p>';
