import {findTouchPair,solveTouchDepth} from './hand-pair-depth.mjs?v=touch2.3';
...
export class HandContactAssist {
 ...
 update({left,right,aspect=1,now,enabled,rangePercent=18,confirmMs=100,maxSideChange=.035}){
  ...
  const pair=findTouchPair(left,right,aspect,this.key,{rangePercent});
