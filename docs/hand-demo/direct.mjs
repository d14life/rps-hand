...
export function directDriver(rig,tips){
 ...
 return function(points,side,palmQ,dt,{staticInput=false,confirmDegrees=0,noiseDegrees=1,smoothingMs=0,movementThresholdMm=0,upperCoupling=0,lockUpper=true,contactPixels=0,contactReleasePixels=12,thickness=1,tipInset=0,adjustPoints=null,thumbTwist=0,lm,width,height}){
  ...
  if(adjustPoints)adjustPoints(p,lm);
