import {palmObservation} from './palm-sweep-depth.mjs?v=photo1';
import {imagePalmSize} from './size-wall-depth.mjs';
import {solveTouchDepth} from './hand-pair-depth.mjs?v=photo1';
import {sweepEndpoints} from './one-hand-sweep.mjs?v=photo1';
