import {drawFace,drawShoulders,drawUpperBody,encodeAux,decodeAux} from './face-overlay.mjs?v=photo1';
import {startTracking,defaults} from './tracking-session.mjs?v=photo1';
...
import {connectLink,packHands,unpackHands} from '../movement/link.mjs?v=photo1';
