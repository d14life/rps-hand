...
function assignWasmExports(wasmExports) {
  _free = Module["_free"] = wasmExports["Ub"];
  _malloc = Module["_malloc"] = wasmExports["Vb"];
  _mediapipeLoggerGetEncodedApiKey = Module["_mediapipeLoggerGetEncodedApiKey"] = wasmExports["Wb"];
  _registerModelResourcesGraphService = Module["_registerModelResourcesGraphService"] = wasmExports["Xb"];
  _bindTextureToStream = Module["_bindTextureToStream"] = wasmExports["Yb"];
  _addBoundTextureToStream = Module["_addBoundTextureToStream"] = wasmExports["Zb"];
  _addDoubleToInputStream = Module["_addDoubleToInputStream"] = wasmExports["_b"];
  _addFloatToInputStream = Module["_addFloatToInputStream"] = wasmExports["$b"];
  _addBoolToInputStream = Module["_addBoolToInputStream"] = wasmExports["ac"];
  _addIntToInputStream = Module["_addIntToInputStream"] = wasmExports["bc"];
  _addUintToInputStream = Module["_addUintToInputStream"] = wasmExports["cc"];
  _addStringToInputStream = Module["_addStringToInputStream"] = wasmExports["dc"];
  _addRawDataSpanToInputStream = Module["_addRawDataSpanToInputStream"] = wasmExports["ec"];
  _allocateBoolVector = Module["_allocateBoolVector"] = wasmExports["fc"];
  _allocateFloatVector = Module["_allocateFloatVector"] = wasmExports["gc"];
  _allocateDoubleVector = Module["_allocateDoubleVector"] = wasmExports["hc"];
  _allocateIntVector = Module["_allocateIntVector"] = wasmExports["ic"];
  _allocateUintVector = Module["_allocateUintVector"] = wasmExports["jc"];
  _allocateStringVector = Module["_allocateStringVector"] = wasmExports["kc"];
  _addBoolVectorEntry = Module["_addBoolVectorEntry"] = wasmExports["lc"];
  _addFloatVectorEntry = Module["_addFloatVectorEntry"] = wasmExports["mc"];
  _addDoubleVectorEntry = Module["_addDoubleVectorEntry"] = wasmExports["nc"];
  _addIntVectorEntry = Module["_addIntVectorEntry"] = wasmExports["oc"];
  _addUintVectorEntry = Module["_addUintVectorEntry"] = wasmExports["pc"];
  _addStringVectorEntry = Module["_addStringVectorEntry"] = wasmExports["qc"];
  _addBoolVectorToInputStream = Module["_addBoolVectorToInputStream"] = wasmExports["rc"];
  _addFloatVectorToInputStream = Module["_addFloatVectorToInputStream"] = wasmExports["sc"];
  _addDoubleVectorToInputStream = Module["_addDoubleVectorToInputStream"] = wasmExports["tc"];
  _addIntVectorToInputStream = Module["_addIntVectorToInputStream"] = wasmExports["uc"];
  _addUintVectorToInputStream = Module["_addUintVectorToInputStream"] = wasmExports["vc"];
  _addStringVectorToInputStream = Module["_addStringVectorToInputStream"] = wasmExports["wc"];
  _addFlatHashMapToInputStream = Module["_addFlatHashMapToInputStream"] = wasmExports["xc"];
  _addProtoToInputStream = Module["_addProtoToInputStream"] = wasmExports["yc"];
  _addEmptyPacketToInputStream = Module["_addEmptyPacketToInputStream"] = wasmExports["zc"];
  _addBoolToInputSidePacket = Module["_addBoolToInputSidePacket"] = wasmExports["Ac"];
  _addDoubleToInputSidePacket = Module["_addDoubleToInputSidePacket"] = wasmExports["Bc"];
  _addFloatToInputSidePacket = Module["_addFloatToInputSidePacket"] = wasmExports["Cc"];
  _addIntToInputSidePacket = Module["_addIntToInputSidePacket"] = wasmExports["Dc"];
  _addUintToInputSidePacket = Module["_addUintToInputSidePacket"] = wasmExports["Ec"];
  _addStringToInputSidePacket = Module["_addStringToInputSidePacket"] = wasmExports["Fc"];
  _addRawDataSpanToInputSidePacket = Module["_addRawDataSpanToInputSidePacket"] = wasmExports["Gc"];
  _addProtoToInputSidePacket = Module["_addProtoToInputSidePacket"] = wasmExports["Hc"];
  _addBoolVectorToInputSidePacket = Module["_addBoolVectorToInputSidePacket"] = wasmExports["Ic"];
  _addDoubleVectorToInputSidePacket = Module["_addDoubleVectorToInputSidePacket"] = wasmExports["Jc"];
  _addFloatVectorToInputSidePacket = Module["_addFloatVectorToInputSidePacket"] = wasmExports["Kc"];
  _addIntVectorToInputSidePacket = Module["_addIntVectorToInputSidePacket"] = wasmExports["Lc"];
  _addUintVectorToInputSidePacket = Module["_addUintVectorToInputSidePacket"] = wasmExports["Mc"];
  _addStringVectorToInputSidePacket = Module["_addStringVectorToInputSidePacket"] = wasmExports["Nc"];
  _attachBoolListener = Module["_attachBoolListener"] = wasmExports["Oc"];
  _attachBoolVectorListener = Module["_attachBoolVectorListener"] = wasmExports["Pc"];
  _attachDoubleListener = Module["_attachDoubleListener"] = wasmExports["Qc"];
  _attachDoubleVectorListener = Module["_attachDoubleVectorListener"] = wasmExports["Rc"];
  _attachFloatListener = Module["_attachFloatListener"] = wasmExports["Sc"];
  _attachFloatVectorListener = Module["_attachFloatVectorListener"] = wasmExports["Tc"];
  _attachIntListener = Module["_attachIntListener"] = wasmExports["Uc"];
  _attachIntVectorListener = Module["_attachIntVectorListener"] = wasmExports["Vc"];
  _attachUintListener = Module["_attachUintListener"] = wasmExports["Wc"];
  _attachUintVectorListener = Module["_attachUintVectorListener"] = wasmExports["Xc"];
  _attachStringListener = Module["_attachStringListener"] = wasmExports["Yc"];
  _attachStringVectorListener = Module["_attachStringVectorListener"] = wasmExports["Zc"];
  _attachProtoListener = Module["_attachProtoListener"] = wasmExports["_c"];
  _attachProtoVectorListener = Module["_attachProtoVectorListener"] = wasmExports["$c"];
  _getGraphConfig = Module["_getGraphConfig"] = wasmExports["ad"];
  _emwgpuCreateBindGroup = wasmExports["bd"];
  _emwgpuCreateBindGroupLayout = wasmExports["cd"];
  _emwgpuCreateCommandBuffer = wasmExports["dd"];
  _emwgpuCreateCommandEncoder = wasmExports["ed"];
  _emwgpuCreateComputePassEncoder = wasmExports["fd"];
  _emwgpuCreateComputePipeline = wasmExports["gd"];
  _emwgpuCreateExternalTexture = wasmExports["hd"];
  _emwgpuCreatePipelineLayout = wasmExports["id"];
  _emwgpuCreateQuerySet = wasmExports["jd"];
  _emwgpuCreateRenderBundle = wasmExports["kd"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["ld"];
  _emwgpuCreateRenderPassEncoder = wasmExports["md"];
  _emwgpuCreateRenderPipeline = wasmExports["nd"];
  _emwgpuCreateSampler = wasmExports["od"];
  _emwgpuCreateSurface = wasmExports["pd"];
  _emwgpuCreateTexture = wasmExports["qd"];
  _emwgpuCreateTextureView = wasmExports["rd"];
  _emwgpuCreateAdapter = wasmExports["sd"];
  _emwgpuImportBuffer = wasmExports["td"];
  _emwgpuCreateDevice = wasmExports["ud"];
  _emwgpuCreateQueue = wasmExports["vd"];
  _emwgpuCreateShaderModule = wasmExports["wd"];
  _clearSubgraphs = Module["_clearSubgraphs"] = wasmExports["xd"];
  _pushBinarySubgraph = Module["_pushBinarySubgraph"] = wasmExports["yd"];
  _pushTextSubgraph = Module["_pushTextSubgraph"] = wasmExports["zd"];
  _changeBinaryGraph = Module["_changeBinaryGraph"] = wasmExports["Ad"];
  _changeTextGraph = Module["_changeTextGraph"] = wasmExports["Bd"];
  _processGl = Module["_processGl"] = wasmExports["Cd"];
  _process = Module["_process"] = wasmExports["Dd"];
  _bindTextureToCanvas = Module["_bindTextureToCanvas"] = wasmExports["Ed"];
  _requestShaderRefreshOnGraphChange = Module["_requestShaderRefreshOnGraphChange"] = wasmExports["Fd"];
  _waitUntilIdle = Module["_waitUntilIdle"] = wasmExports["Gd"];
  _closeGraph = Module["_closeGraph"] = wasmExports["Hd"];
  _setAutoRenderToScreen = Module["_setAutoRenderToScreen"] = wasmExports["Id"];
  _emscripten_builtin_memalign = wasmExports["Kd"];
  __emscripten_tempret_set = wasmExports["Ld"];
  __emscripten_stack_restore = wasmExports["Md"];
  __emscripten_stack_alloc = wasmExports["Nd"];
  _emscripten_stack_get_current = wasmExports["Od"];
  ...
  _kVersionStampBuildHasHardeningProtobuf = Module["_kVersionStampBuildHasHardeningProtobuf"] = wasmExports["Jd"].value;
}
