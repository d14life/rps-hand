...
var _free, _malloc, _mediapipeLoggerGetEncodedApiKey, _registerModelResourcesGraphService, _bindTextureToStream, _addBoundTextureToStream, _addDoubleToInputStream, _addFloatToInputStream, _addBoolToInputStream, _addIntToInputStream, _addUintToInputStream, _addStringToInputStream, _addRawDataSpanToInputStream, _allocateBoolVector, _allocateFloatVector, _allocateDoubleVector, _allocateIntVector, _allocateUintVector, _allocateStringVector, _addBoolVectorEntry, _addFloatVectorEntry, _addDoubleVectorEntry, _addIntVectorEntry, _addUintVectorEntry, _addStringVectorEntry, _addBoolVectorToInputStream, _addFloatVectorToInputStream, _addDoubleVectorToInputStream, _addIntVectorToInputStream, _addUintVectorToInputStream, _addStringVectorToInputStream, _addFlatHashMapToInputStream, _addProtoToInputStream, _addEmptyPacketToInputStream, _addBoolToInputSidePacket, _addDoubleToInputSidePacket, _addFloatToInputSidePacket, _addIntToInputSidePacket, _addUintToInputSidePacket, _addStringToInputSidePacket, _addRawDataSpanToInputSidePacket, _addProtoToInputSidePacket, _addBoolVectorToInputSidePacket, _addDoubleVectorToInputSidePacket, _addFloatVectorToInputSidePacket, _addIntVectorToInputSidePacket, _addUintVectorToInputSidePacket, _addStringVectorToInputSidePacket, _attachBoolListener, _attachBoolVectorListener, _attachDoubleListener, _attachDoubleVectorListener, _attachFloatListener, _attachFloatVectorListener, _attachIntListener, _attachIntVectorListener, _attachUintListener, _attachUintVectorListener, _attachStringListener, _attachStringVectorListener, _attachProtoListener, _attachProtoVectorListener, _getGraphConfig, _emwgpuCreateBindGroup, _emwgpuCreateBindGroupLayout, _emwgpuCreateCommandBuffer, _emwgpuCreateCommandEncoder, _emwgpuCreateComputePassEncoder, _emwgpuCreateComputePipeline, _emwgpuCreateExternalTexture, _emwgpuCreatePipelineLayout, _emwgpuCreateQuerySet, _emwgpuCreateRenderBundle, _emwgpuCreateRenderBundleEncoder, _emwgpuCreateRenderPassEncoder, _emwgpuCreateRenderPipeline, _emwgpuCreateSampler, _emwgpuCreateSurface, _emwgpuCreateTexture, _emwgpuCreateTextureView, _emwgpuCreateAdapter, _emwgpuImportBuffer, _emwgpuCreateDevice, _emwgpuCreateQueue, _emwgpuCreateShaderModule, _clearSubgraphs, _pushBinarySubgraph, _pushTextSubgraph, _changeBinaryGraph, _changeTextGraph, _processGl, _process, _bindTextureToCanvas, _requestShaderRefreshOnGraphChange, _waitUntilIdle, _closeGraph, _setAutoRenderToScreen, _emscripten_builtin_memalign, __emscripten_tempret_set, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_jii, dynCall_ji, dynCall_iiiijij, dynCall_viji, dynCall_viijii, dynCall_ijj, dynCall_jjj, dynCall_iiiijj, dynCall_viijj, dynCall_viiijjj, dynCall_iiiji, dynCall_vij, dynCall_vijjj, dynCall_vj, dynCall_viij, dynCall_jiji, dynCall_iiiiij, dynCall_iiiiijj, dynCall_iiiiiijj, memory, _kVersionStampBuildChangelistStr, _kVersionStampCitcSnapshotStr, _kVersionStampCitcWorkspaceIdStr, _kVersionStampSourceUriStr, _kVersionStampBuildClientStr, _kVersionStampBuildClientMintStatusStr, _kVersionStampBuildCompilerStr, _kVersionStampBuildDateTimePstStr, _kVersionStampBuildDepotPathStr, _kVersionStampBuildIdStr, _kVersionStampBuildInfoStr, _kVersionStampBuildLabelStr, _kVersionStampBuildTargetStr, _kVersionStampBuildTimestampStr, _kVersionStampBuildToolStr, _kVersionStampG3BuildTargetStr, _kVersionStampVerifiableStr, _kVersionStampBuildFdoTypeStr, _kVersionStampBuildBaselineChangelistStr, _kVersionStampBuildLtoTypeStr, _kVersionStampBuildPropellerTypeStr, _kVersionStampBuildPghoTypeStr, _kVersionStampBuildFdoProfileChangelistStr, _kVersionStampBuildMemprofProfileChangelistStr, _kVersionStampBuildUsernameStr, _kVersionStampBuildHostnameStr, _kVersionStampBuildDirectoryStr, _kVersionStampBuildChangelistInt, _kVersionStampCitcSnapshotInt, _kVersionStampBuildClientMintStatusInt, _kVersionStampBuildTimestampInt, _kVersionStampVerifiableInt, _kVersionStampBuildCoverageEnabledInt, _kVersionStampBuildBaselineChangelistInt, _kVersionStampPrecookedTimestampStr, _kVersionStampPrecookedClientInfoStr, __indirect_function_table, _kVersionStampBuildHasHardeningProtobuf, wasmMemory, wasmTable;

function assignWasmExports(wasmExports) {
  _free = Module["_free"] = wasmExports["Vb"];
  _malloc = Module["_malloc"] = wasmExports["Wb"];
  _mediapipeLoggerGetEncodedApiKey = Module["_mediapipeLoggerGetEncodedApiKey"] = wasmExports["Xb"];
  _registerModelResourcesGraphService = Module["_registerModelResourcesGraphService"] = wasmExports["Yb"];
  _bindTextureToStream = Module["_bindTextureToStream"] = wasmExports["Zb"];
  _addBoundTextureToStream = Module["_addBoundTextureToStream"] = wasmExports["_b"];
  _addDoubleToInputStream = Module["_addDoubleToInputStream"] = wasmExports["$b"];
  _addFloatToInputStream = Module["_addFloatToInputStream"] = wasmExports["ac"];
  _addBoolToInputStream = Module["_addBoolToInputStream"] = wasmExports["bc"];
  _addIntToInputStream = Module["_addIntToInputStream"] = wasmExports["cc"];
  _addUintToInputStream = Module["_addUintToInputStream"] = wasmExports["dc"];
  _addStringToInputStream = Module["_addStringToInputStream"] = wasmExports["ec"];
  _addRawDataSpanToInputStream = Module["_addRawDataSpanToInputStream"] = wasmExports["fc"];
  _allocateBoolVector = Module["_allocateBoolVector"] = wasmExports["gc"];
  _allocateFloatVector = Module["_allocateFloatVector"] = wasmExports["hc"];
  _allocateDoubleVector = Module["_allocateDoubleVector"] = wasmExports["ic"];
  _allocateIntVector = Module["_allocateIntVector"] = wasmExports["jc"];
  _allocateUintVector = Module["_allocateUintVector"] = wasmExports["kc"];
  _allocateStringVector = Module["_allocateStringVector"] = wasmExports["lc"];
  _addBoolVectorEntry = Module["_addBoolVectorEntry"] = wasmExports["mc"];
  _addFloatVectorEntry = Module["_addFloatVectorEntry"] = wasmExports["nc"];
  _addDoubleVectorEntry = Module["_addDoubleVectorEntry"] = wasmExports["oc"];
  _addIntVectorEntry = Module["_addIntVectorEntry"] = wasmExports["pc"];
  _addUintVectorEntry = Module["_addUintVectorEntry"] = wasmExports["qc"];
  _addStringVectorEntry = Module["_addStringVectorEntry"] = wasmExports["rc"];
  _addBoolVectorToInputStream = Module["_addBoolVectorToInputStream"] = wasmExports["sc"];
  _addFloatVectorToInputStream = Module["_addFloatVectorToInputStream"] = wasmExports["tc"];
  _addDoubleVectorToInputStream = Module["_addDoubleVectorToInputStream"] = wasmExports["uc"];
  _addIntVectorToInputStream = Module["_addIntVectorToInputStream"] = wasmExports["vc"];
  _addUintVectorToInputStream = Module["_addUintVectorToInputStream"] = wasmExports["wc"];
  _addStringVectorToInputStream = Module["_addStringVectorToInputStream"] = wasmExports["xc"];
  _addFlatHashMapToInputStream = Module["_addFlatHashMapToInputStream"] = wasmExports["yc"];
  _addProtoToInputStream = Module["_addProtoToInputStream"] = wasmExports["zc"];
  _addEmptyPacketToInputStream = Module["_addEmptyPacketToInputStream"] = wasmExports["Ac"];
  _addBoolToInputSidePacket = Module["_addBoolToInputSidePacket"] = wasmExports["Bc"];
  _addDoubleToInputSidePacket = Module["_addDoubleToInputSidePacket"] = wasmExports["Cc"];
  _addFloatToInputSidePacket = Module["_addFloatToInputSidePacket"] = wasmExports["Dc"];
  _addIntToInputSidePacket = Module["_addIntToInputSidePacket"] = wasmExports["Ec"];
  _addUintToInputSidePacket = Module["_addUintToInputSidePacket"] = wasmExports["Fc"];
  _addStringToInputSidePacket = Module["_addStringToInputSidePacket"] = wasmExports["Gc"];
  _addRawDataSpanToInputSidePacket = Module["_addRawDataSpanToInputSidePacket"] = wasmExports["Hc"];
  _addProtoToInputSidePacket = Module["_addProtoToInputSidePacket"] = wasmExports["Ic"];
  _addBoolVectorToInputSidePacket = Module["_addBoolVectorToInputSidePacket"] = wasmExports["Jc"];
  _addDoubleVectorToInputSidePacket = Module["_addDoubleVectorToInputSidePacket"] = wasmExports["Kc"];
  _addFloatVectorToInputSidePacket = Module["_addFloatVectorToInputSidePacket"] = wasmExports["Lc"];
  _addIntVectorToInputSidePacket = Module["_addIntVectorToInputSidePacket"] = wasmExports["Mc"];
  _addUintVectorToInputSidePacket = Module["_addUintVectorToInputSidePacket"] = wasmExports["Nc"];
  _addStringVectorToInputSidePacket = Module["_addStringVectorToInputSidePacket"] = wasmExports["Oc"];
  _attachBoolListener = Module["_attachBoolListener"] = wasmExports["Pc"];
  _attachBoolVectorListener = Module["_attachBoolVectorListener"] = wasmExports["Qc"];
  _attachDoubleListener = Module["_attachDoubleListener"] = wasmExports["Rc"];
  _attachDoubleVectorListener = Module["_attachDoubleVectorListener"] = wasmExports["Sc"];
  _attachFloatListener = Module["_attachFloatListener"] = wasmExports["Tc"];
  _attachFloatVectorListener = Module["_attachFloatVectorListener"] = wasmExports["Uc"];
  _attachIntListener = Module["_attachIntListener"] = wasmExports["Vc"];
  _attachIntVectorListener = Module["_attachIntVectorListener"] = wasmExports["Wc"];
  _attachUintListener = Module["_attachUintListener"] = wasmExports["Xc"];
  _attachUintVectorListener = Module["_attachUintVectorListener"] = wasmExports["Yc"];
  _attachStringListener = Module["_attachStringListener"] = wasmExports["Zc"];
  _attachStringVectorListener = Module["_attachStringVectorListener"] = wasmExports["_c"];
  _attachProtoListener = Module["_attachProtoListener"] = wasmExports["$c"];
  _attachProtoVectorListener = Module["_attachProtoVectorListener"] = wasmExports["ad"];
  _getGraphConfig = Module["_getGraphConfig"] = wasmExports["bd"];
  _emwgpuCreateBindGroup = wasmExports["cd"];
  _emwgpuCreateBindGroupLayout = wasmExports["dd"];
  _emwgpuCreateCommandBuffer = wasmExports["ed"];
  _emwgpuCreateCommandEncoder = wasmExports["fd"];
  _emwgpuCreateComputePassEncoder = wasmExports["gd"];
  _emwgpuCreateComputePipeline = wasmExports["hd"];
  _emwgpuCreateExternalTexture = wasmExports["id"];
  _emwgpuCreatePipelineLayout = wasmExports["jd"];
  _emwgpuCreateQuerySet = wasmExports["kd"];
  _emwgpuCreateRenderBundle = wasmExports["ld"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["md"];
  _emwgpuCreateRenderPassEncoder = wasmExports["nd"];
  _emwgpuCreateRenderPipeline = wasmExports["od"];
  _emwgpuCreateSampler = wasmExports["pd"];
  _emwgpuCreateSurface = wasmExports["qd"];
  _emwgpuCreateTexture = wasmExports["rd"];
  _emwgpuCreateTextureView = wasmExports["sd"];
  _emwgpuCreateAdapter = wasmExports["td"];
  _emwgpuImportBuffer = wasmExports["ud"];
  _emwgpuCreateDevice = wasmExports["vd"];
  _emwgpuCreateQueue = wasmExports["wd"];
  _emwgpuCreateShaderModule = wasmExports["xd"];
  _clearSubgraphs = Module["_clearSubgraphs"] = wasmExports["yd"];
  _pushBinarySubgraph = Module["_pushBinarySubgraph"] = wasmExports["zd"];
  _pushTextSubgraph = Module["_pushTextSubgraph"] = wasmExports["Ad"];
  _changeBinaryGraph = Module["_changeBinaryGraph"] = wasmExports["Bd"];
  _changeTextGraph = Module["_changeTextGraph"] = wasmExports["Cd"];
  _processGl = Module["_processGl"] = wasmExports["Dd"];
  _process = Module["_process"] = wasmExports["Ed"];
  _bindTextureToCanvas = Module["_bindTextureToCanvas"] = wasmExports["Fd"];
  _requestShaderRefreshOnGraphChange = Module["_requestShaderRefreshOnGraphChange"] = wasmExports["Gd"];
  _waitUntilIdle = Module["_waitUntilIdle"] = wasmExports["Hd"];
  _closeGraph = Module["_closeGraph"] = wasmExports["Id"];
  _setAutoRenderToScreen = Module["_setAutoRenderToScreen"] = wasmExports["Jd"];
  _emscripten_builtin_memalign = wasmExports["Ld"];
  __emscripten_tempret_set = wasmExports["Md"];
  __emscripten_stack_restore = wasmExports["Nd"];
  __emscripten_stack_alloc = wasmExports["Od"];
  _emscripten_stack_get_current = wasmExports["Pd"];
  ...
  _kVersionStampBuildHasHardeningProtobuf = Module["_kVersionStampBuildHasHardeningProtobuf"] = wasmExports["Kd"].value;
}
