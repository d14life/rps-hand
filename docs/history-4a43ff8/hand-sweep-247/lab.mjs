...
import {receivePhone} from './video-link.mjs?v=shared-phone1';
...
function loadVideo245(){
 ...
 pipelineInfo.textContent='Saved video calibration active for both hands and head. Connect your camera or use Connect iPhone camera. No new sweep required; recording another sweep replaces this reference.';
 ...
 notice('Saved video settings ready. Connect camera or Connect iPhone camera.');
}
