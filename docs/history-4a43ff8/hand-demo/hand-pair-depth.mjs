...
export function findTouchPair(left,right,aspect=1,previousKey=null){
 ...
 if(size<=0)return null;const threshold=Math.max(.002,Math.min(.022,size*.18)),A=contactSamples(left.lm,left.points),B=contactSamples(right.lm,right.points);let best=null;
