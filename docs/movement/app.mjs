...
function controlsChanged(){held.reset();swipe.reset();demoRun=null;trackingUI.clear();$('hint').textContent='Start camera, hold your thumb comfortably still for a moment, then move it to walk. Keep the other fingers curled. Wrap your thumb against your fist to stop. Lift it and pause briefly to centre again. The Rest button also pauses.';status('Start camera · thumb joystick ready');}
