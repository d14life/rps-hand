...
export function receivePhone(onStream,onStatus,onEnd){
 ...
 box.innerHTML='<h2>Use your phone camera</h2><p>Scan with your phone, then tap Start camera.<br>Keep both devices on the same Wi-Fi.</p><div class="qr"></div><p><a target="_blank" rel="noopener">Open phone camera page</a></p><p class="pairStatus">Creating connection…</p><button>Cancel connection</button>';
