import {drawFace,drawShoulders,projectFaceDots} from './face-overlay.mjs?v=pnpsimple2';
import {bindFaceDots,updateFaceDots} from './face-bindings.mjs?v=pnpsimple2';
...
import {faceReference,calibratedDepth,eyeCenter,eyeCenters} from './head-depth.mjs?v=pnpsimple2';
