import {drawFace,drawShoulders,projectFaceDots} from './face-overlay.mjs?v=pnpsimple1';
import {bindFaceDots,updateFaceDots} from './face-bindings.mjs?v=pnpsimple1';
...
import {faceReference,calibratedDepth,eyeCenter,eyeCenters} from './head-depth.mjs?v=pnpsimple1';
