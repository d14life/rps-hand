import {drawFace,drawShoulders,projectFaceDots} from './face-overlay.mjs?v=scale0925v2';
import {bindFaceDots,updateFaceDots} from './face-bindings.mjs?v=scale0925v2';
...
import {faceReference,calibratedDepth,eyeCenter,eyeCenters} from './head-depth.mjs?v=scale0925v2';
