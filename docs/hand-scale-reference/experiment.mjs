import {calibratedReference} from './reference-scale.mjs?v=scale0925v2';
import {fitNeckSweep} from './neck-sweep.mjs?v=scale0925v2';
import {OneHandSweep} from './one-hand-sweep.mjs?v=scale0925v2';
...
export function installExperiment({container,getHead,getFocal=()=>1,onReference=()=>{},onBegin=()=>{},getNeckReference=()=>null}){
 ...
 panel.innerHTML=`<h2>Fixed scale 0.092535 · sweep comparison</h2>
 ...
 <p id="touchStatus" role="status" aria-live="polite">Comparison: fixed 0.092535 scale replaces the model/camera scale; record to save your neck reference.</p>
