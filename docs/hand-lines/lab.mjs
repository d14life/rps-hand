import {directDriver} from './direct.mjs?v=8';
...
configureSide();renderLibrary();updateMode();resize();notice('Direct Lines ready. Connect camera or Phone camera · QR. Original direct joint motion restored. Mesh dimensions are fixed.');
