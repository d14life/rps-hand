import {drawFace,drawShoulders,projectFaceDots} from './face-overlay.mjs?v=photo1';
import {bindFaceDots,updateFaceDots} from './face-bindings.mjs?v=photo1';
...
import {faceReference,calibratedDepth,eyeCenter,eyeCenters} from './head-depth.mjs?v=photo1';
