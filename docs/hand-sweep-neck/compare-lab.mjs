...
await rig.ready;const {snapshotModel,installSweepSettings}=await import('../hand-compare/settings.mjs?v=camera3');const restoreModel=snapshotModel(rig);const photoReport=variant==='archive'?null:fitPhotoHand(rig);
