...
export class CombinedHead {
 ...
 neckReference(palm,focal,wrist){
  ...
  // During declared neck contact, the skin behind the palm joint centres
  // meets this fixed neck surface. Return a wrist depth; never move the head.
  const palmOffset=palm.z-wrist.z,targetDepth=best.depth-.006+palmOffset;
  return targetDepth>.04&&targetDepth<4?targetDepth:null;
 }
