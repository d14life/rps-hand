...
await rig.ready;const {snapshotModel,installSweepSettings}=await import('./settings.mjs?v=raw19');const restoreModel=snapshotModel(rig);const photoReport=fitPhotoHand(rig);
