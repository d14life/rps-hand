...
let firstPerson=null,editorGun=null;
...
if(location.hostname==='127.0.0.1'&&new URLSearchParams(location.search).has('verify')){
 const {verifyEditor}=await import('../.lab-qa/editor-verify.mjs?v=1');
