...
if(!document.body.dataset.mapLab){
 ...
 const labLinks=document.createElement('p');labLinks.innerHTML='<a href="hands-lines.html?v=linecopy3">2D lines + depth lab</a> · <a href="hands.html?v=eyegaze1">Current hands + head</a> · <a href="hands-102.html?v=eyegaze1">Archived #102 test</a> · <a href="held-gun.html?v=eyegaze1">Held-gun lab</a> · <a href="./?v=eyegaze1">Full editor</a>';$('directSettings').prepend(labLinks);
