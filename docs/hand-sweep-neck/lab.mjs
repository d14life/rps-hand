...
import {directDriver} from '../hand-pnp-photo/direct.mjs?v=raw19';
...
await rig.ready;const {snapshotModel,installSweepSettings}=await import('./settings.mjs?v=constraints21');const restoreModel=snapshotModel(rig);const photoReport=fitPhotoHand(rig);
