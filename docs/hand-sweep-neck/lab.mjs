...
await rig.ready;const {snapshotModel,installSweepSettings}=await import('./settings.mjs?v=settings12');const restoreModel=snapshotModel(rig);const photoReport=fitPhotoHand(rig);
