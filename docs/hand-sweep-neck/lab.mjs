...
await rig.ready;const {snapshotModel,installSweepSettings}=await import('./settings.mjs?v=defaults20');const restoreModel=snapshotModel(rig);const photoReport=fitPhotoHand(rig);
