...
import {directDriver as archive102Driver} from './archive-102-driver.mjs?v=linecopy2';
...
function refreshOtherLines(){
 if(isLineCopy&&latest){
  ...
  if(result&&metrics){
   ...
   metrics.textContent='Finger line fit: '+fit.lineRms.toFixed(2)+' px RMS · '+fit.lineMax.toFixed(2)+' px maximum. Finger roots stay attached to the palm (largest shift from tracked root: '+fit.baseMax.toFixed(1)+' px). Largest segment length change from photo: '+Math.round(maxStretch*100)+'%.';
  }
 }
...
if(!document.body.dataset.mapLab){
 ...
 const labLinks=document.createElement('p');labLinks.innerHTML='<a href="hands-lines.html?v=linecopy2">Exact 2D lines</a> · <a href="hands.html?v=eyegaze1">Current hands + head</a> · <a href="hands-102.html?v=eyegaze1">Archived #102 test</a> · <a href="held-gun.html?v=eyegaze1">Held-gun lab</a> · <a href="./?v=eyegaze1">Full editor</a>';$('directSettings').prepend(labLinks);
