import {fitNeckSweep} from './neck-sweep.mjs?v=touch2.4.16-final';
import {OneHandSweep} from './one-hand-sweep.mjs?v=touch2.4.16-final';
...
export function installExperiment({container,getHead,getFocal=()=>1,onReference=()=>{},onBegin=()=>{},getNeckReference=()=>null}){
 ...
 panel.innerHTML=`<h2>Front-to-neck sweep · 2.4.16</h2>
