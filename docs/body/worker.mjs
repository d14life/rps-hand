...
import {upperBodyPose} from './pose.mjs';
const DELEGATES=new URLSearchParams(self.location.search).get('delegate')==='CPU'?['CPU']:['GPU','CPU'];   // ?delegate=CPU on the worker URL
let tracker;
try{
